...
const Form = () => {
  return (
    <div className="Frame flex gap-2 p-6">
      <div>
      ...
      <div className="bg-lime w-[492px] h-[560px] p-6 border rounded-md">
        <div>
          ...
          <p className="font-extralight">
            Prices may change depending the length of rental and the price of
            your rental car.{" "}
          </p>
        </div>
        <div className="flex mt-6 justify-between">
          <div className="bg-[url('/blue.png')] bg-cover bg-center w-[120px] h-[100px] flex flex-col border rounded-md items-start justify-center p-6">
            <Image src="/gtr.png" alt="Car view" width={105} height={32} />
          </div>
          <div>
            <h1 className="font-bold l">Nissan GTR</h1>
